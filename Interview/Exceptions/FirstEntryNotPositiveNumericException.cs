...
{
    /// <summary>FirstEntryNotPositiveNumericException class</summary>
    public class FirstEntryNotPositiveNumericException : Exception
    {
        /// <summary>Initializes a new instance of the FirstEntryNotPositiveNumericException class</summary>
        /// <param name="message">Prompt message that the user will see</param>
        public FirstEntryNotPositiveNumericException(string message)
        {
